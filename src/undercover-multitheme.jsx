...
// ─── THEMES ────────────────────────────────────────────────────────────────────
// chemin de l'app : C:\Windows\System32\undercover-app\src
const THEMES = {
  dbz: {
    id: "dbz",
    label: "Dragon Ball Z",
  ...
  yugioh: {
    ...
    pulseColor: "#a855f7",
    characters: ["Yugi","Kaiba","Joey","Jaden","Zane","Bakura","Marek","Pegasus","Sirius","Alexia Rodes","Makuba","Mako Tsnuami","Rex","Insector Haga","Mai"],
    pairs: [
  ...
  pokemon: {
    ...
    pairs: [
      ...
      { civil: "Dracolosse", undercover: "Dracofeu" },
