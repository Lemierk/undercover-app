...
const THEMES = {
  dbz: {
    ...
    pulseColor: "#f5a623",
    characters: ["Goku","Vegeta","Gohan","Piccolo","Trunks","Krilin","Yamcha","Ten Shin Han","Bulma","C-18","Freezer","Cell","Buu","Broly","Bardock"],
    pairs: [
  ...
  yugioh: {
    ...
    pulseColor: "#a855f7",
    characters: ["Yugi","Kaiba","Joey","Tea","Tristan","Bakura","Marik","Pegasus","Ishizu","Odion","Mokuba","Shadi","Rex","Weevil","Mai"],
    pairs: [
      { civil: "Dark Magician", undercover: "Dark Magician Girl" },
      { civil: "Blue-Eyes White Dragon", undercover: "Blue-Eyes Ultimate Dragon" },
      { civil: "Exodia", undercover: "The Winged Dragon of Ra" },
      { civil: "Duel Disk", undercover: "Duel Runner" },
      { civil: "Pot of Greed", undercover: "Pot of Avarice" },
      { civil: "Mirror Force", undercover: "Magic Cylinder" },
      { civil: "Millenium Puzzle", undercover: "Millenium Ring" },
      { civil: "Duel Monster", undercover: "Shadow Game" },
      { civil: "XYZ Monster", undercover: "Synchro Monster" },
      { civil: "Trap Card", undercover: "Magic Card" },
      { civil: "Monster Reborn", undercover: "Call of the Haunted" },
      { civil: "Seto Kaiba", undercover: "Yami Yugi" },
      { civil: "Shadow Realm", undercover: "Dark World" },
      { civil: "Duelist Kingdom", undercover: "Battle City" },
      { civil: "Red-Eyes Black Dragon", undercover: "Meteor Black Dragon" },
    ],
  },
  ...
  pokemon: {
    ...
    pulseColor: "#facc15",
    characters: ["Sacha","Pikachu","Misty","Ondine","Brock","Pierre","Jessie","James","Meowth","Professeur Chen","Gary","Tracey","May","Max","Dawn"],
    pairs: [
      { civil: "Pikachu", undercover: "Raichu" },
      { civil: "Poké Ball", undercover: "Master Ball" },
      { civil: "Dresseur", undercover: "Champion" },
      { civil: "Attaque Tonnerre", undercover: "Électacle" },
      { civil: "Évolution", undercover: "Méga-Évolution" },
      { civil: "Pokédex", undercover: "PokéNav" },
      { civil: "Arène", undercover: "Ligue Pokémon" },
      { civil: "Capacité", undercover: "Talent" },
      ...
      { civil: "Dracolosse", undercover: "Draco" },
      { civil: "Mewtwo", undercover: "Mew" },
      { civil: "Génération 1", undercover: "Génération 2" },
    ],
  },
  ...
  got: {
    ...
    pairs: [
      ...
      { civil: "Trône de Fer", undercover: "Trône de Pierre" },
      { civil: "Dracarys", undercover: "Valar Morghulis" },
      { civil: "Garde de Nuit", undercover: "Gardiens du Mur" },
      ...
      { civil: "Mur de glace", undercover: "Muraille noire" },
      { civil: "Marcheur Blanc", undercover: "Sauvage" },
      { civil: "Drogon", undercover: "Viserion" },
      { civil: "Mariage Rouge", undercover: "Noce Pourpre" },
      { civil: "Cersei", undercover: "Margaery" },
      { civil: "Arya", undercover: "Faceless Man" },
      { civil: "Rhaenyra", undercover: "Alicent" },
      { civil: "Valyrien", undercover: "Braavosi" },
      { civil: "Dragons de Daenerys", undercover: "Dragons de Rhaenyra" },
  ...
  harrypotter: {
    ...
    pulseColor: "#c084fc",
    characters: ["Harry","Hermione","Ron","Dumbledore","Voldemort","Snape","Drago","Hagrid","Sirius","Lupin","Bellatrix","Neville","Luna","Dobby","McGonagall"],
    pairs: [
      { civil: "Gryffondor", undercover: "Serdaigle" },
      { civil: "Serpentard", undercover: "Poufsouffle" },
      { civil: "Poudlard", undercover: "Beauxbâtons" },
      { civil: "Patronus", undercover: "Horcruxe" },
      { civil: "Expelliarmus", undercover: "Stupefix" },
      { civil: "Avada Kedavra", undercover: "Crucio" },
      { civil: "Baguette magique", undercover: "Bâton de sorcier" },
      { civil: "Quidditch", undercover: "Quadpot" },
      { civil: "Vif d'or", undercover: "Cognard" },
      { civil: "Choixpeau", undercover: "Miroir du Riséd" },
      ...
      { civil: "Plateforme 9¾", undercover: "Poudlard Express" },
      { civil: "Marauders Map", undercover: "Miroir magique" },
    ],
  },
  ...
  starwars: {
    ...
    pulseColor: "#38bdf8",
    characters: ["Luke","Leia","Han Solo","Yoda","Dark Vader","Obi-Wan","Général Grievous","Ahsoka Tano","Boba Fett","Chewbacca","R2-D2","C-3PO","Palpatine","Mace Windu","Anakin"],
    pairs: [
      ...
      { civil: "Dark Maul", undercover: "Comte Doku" },
